...
var eventSelectOptions = []discordgo.SelectMenuOption{
	...
	{
		Label:       types.EventCoinBalanceChange.Name(),
		Value:       types.EventCoinBalanceChange.Name(),
		Description: types.EventCoinBalanceChange.Description(),
	},
	{
		Label:       types.EventTransferObject.Name(),
		Value:       types.EventTransferObject.Name(),
		Description: types.EventTransferObject.Description(),
	},
	{
		Label:       types.EventNewObject.Name(),
		Value:       types.EventNewObject.Name(),
		Description: types.EventNewObject.Description(),
	},
	{
		Label:       types.EventEpochChange.Name(),
		Value:       types.EventEpochChange.Name(),
		Description: types.EventEpochChange.Description(),
	},
}
